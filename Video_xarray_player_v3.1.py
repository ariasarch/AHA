...
from PySide6.QtWidgets import QApplication, QDialog, QPushButton, QVBoxLayout, QLabel, QFileDialog
...
class Threading(QThread):
    ...
    def __init__(self, parent=None):
        ...
        self.frame_index = 0  # Add frame index to keep track of current frame
    ...
    def stop(self):
        ...
        self.frame_index = 0  # Reset frame index when video is stopped
